...
`;
  ...
  // supra-markdown-entry.cjs
  var require_supra_markdown_entry = __commonJS({
    "supra-markdown-entry.cjs"(exports, module) {
      var MarkdownIt = require_index_cjs4();
      var createDOMPurify = require_purify_cjs();
      function messengerCopyTagPlugin(md2) {
        const TAG_OPEN = "[copy]";
        const TAG_CLOSE = "[/copy]";
        md2.inline.ruler.before("text", "messenger_copy", (state, silent) => {
          const start = state.pos;
        ...
        md2.renderer.rules.messenger_copy = (tokens, idx) => {
          const content = tokens[idx].content || "";
          const inner = md2.renderInline(content);
      ...
      var ALLOWED_ATTR = ["href", "class", "role", "tabindex"];
      ...
      var api = { render: renderMarkdownSource };
  ...
  return require_supra_markdown_entry();
})();
